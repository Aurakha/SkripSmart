...
Partial Class FormKonsulTMJ10
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(596, 516)
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(520, 40)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa tertarik kamu pada gagasan bahwa sebuah aplikasi bisa berjalan " & vbCrLf & "di banyak lokasi sekaligus tanpa kamu melihat fisik servernya?"
        ...
        ' ProgressBar1
        ' 
        ProgressBar1.Location = New Point(28, 70)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(259, 516)
