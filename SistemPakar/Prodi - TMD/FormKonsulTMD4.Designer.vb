...
Partial Class FormKonsulTMD4
    ...
    Private Sub InitializeComponent()
        ...
        Label6.TabIndex = 0
        Label6.Text = "Seberapa tertarik kamu melihat bagaimana " & vbCrLf & "gambar atau objek bisa " & ChrW(8220) & "hidup" & ChrW(8221) & " melalui gerakan"
        ...
        GroupBox1.Location = New Point(266, 193)
        ...
        Panel3.Location = New Point(266, 94)
        Panel3.Name = "Panel3"
        ...
        ' Button3
        ' 
        Button3.Location = New Point(603, 529)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(266, 529)
