...
Partial Class KonsultasiLvl1_12_
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(66, 13)
        Label6.Name = "Label6"
        Label6.Size = New Size(389, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa suka kamu mengekspresikan diri " & vbCrLf & "melalui gambar, warna, bentuk, atau gaya visual?"
