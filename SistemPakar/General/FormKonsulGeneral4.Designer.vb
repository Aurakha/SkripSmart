...
Partial Class KonsultasiLvl1_4_
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(106, 14)
        Label6.Name = "Label6"
        Label6.Size = New Size(306, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa tertarik kamu dengan " & vbCrLf & "jaringan, server, atau perangkat keras?"
        ...
        RadioButton1.Size = New Size(198, 24)
