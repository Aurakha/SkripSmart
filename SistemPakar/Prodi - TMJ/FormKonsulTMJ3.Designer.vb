...
Partial Class FormKonsulTMJ3
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(600, 517)
        ...
        Label6.TabIndex = 0
        Label6.Text = "Seberapa besar rasa penasaranmu terhadap bagaimana " & vbCrLf & "informasi dapat dilindungi dari akses yang tidak diinginkan"
        ...
        ' Button2
        ' 
        Button2.Location = New Point(263, 517)
