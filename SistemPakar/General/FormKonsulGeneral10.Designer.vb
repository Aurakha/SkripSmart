...
Partial Class KonsultasiLvl1_10_
    ...
    Private Sub InitializeComponent()
        ...
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu kegiatan yang " & vbCrLf & "melibatkan imajinasi atau eksplorasi konsep kreatif?"
