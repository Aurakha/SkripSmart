...
Partial Class FormKonsulTMJ11
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(596, 519)
        ...
        GroupBox1.Location = New Point(259, 192)
        ...
        Panel3.Location = New Point(259, 93)
        Panel3.Name = "Panel3"
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(507, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu memikirkan bagaimana sistem dapat " & vbCrLf & "bertahan dan tetap aktif meski salah satu komponennya gagal?"
        ...
        ' ProgressBar1
        ' 
        ProgressBar1.Location = New Point(27, 70)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(259, 519)
