...
Partial Class FormKonsulTMJ4
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(600, 529)
        ...
        ' ProgressBar1
        ' 
        ProgressBar1.Location = New Point(26, 70)
        ...
        Label6.Font = New Font("Segoe UI Semibold", 10.0F, FontStyle.Bold)
        Label6.Location = New Point(3, 13)
        Label6.Name = "Label6"
        Label6.Size = New Size(537, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu bekerja langsung dengan perangkat fisik " & vbCrLf & "dan melihat bagaimana setiap komponen berpengaruh"
        ...
        Label8.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label7.Font = New Font("Segoe UI Semibold", 10.0F, FontStyle.Bold)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(263, 529)
        ...
        GroupBox1.Location = New Point(263, 193)
