...
Partial Class FormKonsulTMJ9
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(589, 548)
        ...
        Label6.Location = New Point(97, 14)
        Label6.Name = "Label6"
        Label6.Size = New Size(344, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa besar minatmu memahami pola " & vbCrLf & "komunikasi antar perangkat dalam jaringan"
        ...
        ' Button2
        ' 
        Button2.Location = New Point(252, 548)
