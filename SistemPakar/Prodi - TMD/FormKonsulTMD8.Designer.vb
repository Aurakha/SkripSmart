...
Partial Class FormKonsulTMD8
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Location = New Point(25, 14)
        Label6.Name = "Label6"
        Label6.Size = New Size(475, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa sering kamu membayangkan bagaimana " & vbCrLf & "seseorang berinteraksi dengan dunia digital yang kamu buat"
