...
Partial Class FormKonsulTMJ8
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(596, 514)
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(406, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu menelusuri alur koneksi " & vbCrLf & "untuk menemukan bagian yang menghambat"
        ...
        ' ProgressBar1
        ' 
        ProgressBar1.Location = New Point(25, 70)
