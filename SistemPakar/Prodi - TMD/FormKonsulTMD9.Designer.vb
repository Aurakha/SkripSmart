...
Partial Class FormKonsulTMD9
    ...
    Private Sub InitializeComponent()
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(479, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu mengembangkan ide " & vbCrLf & "tentang bagaimana pemain berinteraksi dengan dunia digital"
        ...
        GroupBox1.Location = New Point(265, 192)
        ...
        Label7.Location = New Point(610, 33)
        Label7.Name = "Label7"
        ...
        Panel3.Location = New Point(265, 93)
        Panel3.Name = "Panel3"
        ...
        ' Button3
        ' 
        Button3.Location = New Point(602, 528)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(265, 528)
