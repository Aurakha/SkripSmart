...
Partial Class FormKonsulTI9
    ...
    Private Sub InitializeComponent()
        ...
        Panel3.Location = New Point(257, 93)
        Panel3.Name = "Panel3"
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(484, 46)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa menikmati kamu merancang cara penyimpanan " & vbCrLf & "informasi agar tetap terstruktur meski datanya sangat banyak"
        ...
        GroupBox1.Location = New Point(257, 192)
        ...
        ' Button3
        ' 
        Button3.Location = New Point(601, 520)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(264, 520)
