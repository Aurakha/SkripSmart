...
Partial Class FormKonsulTMD2
    ...
    Private Sub InitializeComponent()
        ...
        Label6.TabIndex = 0
        Label6.Text = "Seberapa sering kamu memperhatikan detail visual " & vbCrLf & "seperti warna, proporsi, atau keseimbangan dalam sebuah karya"
        ...
        Label7.Location = New Point(611, 35)
        Label7.Name = "Label7"
