...
Partial Class FormKonsulTMJ12
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(600, 520)
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(521, 38)
        Label6.TabIndex = 0
        Label6.Text = "Seberapa besar minatmu terhadap teknologi yang memungkinkan proses " & vbCrLf & "dilakukan otomatis, seperti penambahan kapasitas tanpa campur tangan manusia?"
        ...
        ' ProgressBar1
        ' 
        ProgressBar1.Location = New Point(31, 70)
