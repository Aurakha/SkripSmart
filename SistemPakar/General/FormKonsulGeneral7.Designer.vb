...
Partial Class KonsultasiLvl1_7_
    ...
    Private Sub InitializeComponent()
        ...
        ' Button3
        ' 
        Button3.Location = New Point(591, 529)
        ...
        Label6.TabIndex = 0
        Label6.Text = "Seberapa besar minatmu dalam menulis program " & vbCrLf & "atau membuat solusi berbasis kode"
        ...
        ' Button2
        ' 
        Button2.Location = New Point(254, 529)
